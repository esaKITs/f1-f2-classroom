...
本ツールは **esaKITs — Enhanced Smart AI Kits** の教育用ツールとして公開します。
画面ヘッダーおよびソースに esaKITs のブランド・著作権表記を含みます。
...
多角形比較を追加した公開版 v1.1.0 に、esaKITs 標準ブランド表記を追加したパッチ版です。多角形比較・SVG保存などの機能仕様は変更していません。
